...
- **48 tools** — chain reads, oracle/AMM quotes, governance/staking reads, Aave supplied balances, GoodDollar identity link/whitelist/entitlement, Self verify/lookup, AgentKarma reputation (read-only external API)
